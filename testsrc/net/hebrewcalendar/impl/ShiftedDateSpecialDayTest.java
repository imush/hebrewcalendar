...
{
    private static final NthDayOfWeekInMonthSpecialDay<GregorianCalendar> thanksgiving =
    ...
    private static final MonthDaySpecialDay<JewishCalendar> chanukah =
            new MonthDaySpecialDay<>(ICalendar.JEWISH, "Chanukah 1st day", 9, 25);

    @Test
    public void testFridayAfterThanksgiving()
    {
        SpecialDay<GregorianCalendar> fridayAfterThanksgiving = new ShiftedDateSpecialDay<>(
                "Friday after Thanksgiving", thanksgiving, 1);
        IDate<GregorianCalendar> d0 = ICalendar.GREGORIAN.fromYMD(2016, 11, 25);
        IDate<GregorianCalendar> d1 = ICalendar.GREGORIAN.fromYMD(2017, 11, 24);
    ...
    {
        SpecialDay<JewishCalendar> erevRH = new ShiftedDateSpecialDay<>(
                "Erev Rosh Hashana", roshHashana, -1);
        IDate<GregorianCalendar> d0 = ICalendar.GREGORIAN.fromYMD(2016, 10, 2);
        IDate<GregorianCalendar> d1 = ICalendar.GREGORIAN.fromYMD(2017, 9, 20);
        IDate<GregorianCalendar> d2 = ICalendar.GREGORIAN.fromYMD(2016, 10, 3);
    ...
    {
        SpecialDay<JewishCalendar> zoisChanuka = new ShiftedDateSpecialDay<>("Zois Chanuka", chanukah, 7);
        // 8th day of Chanukah 5777 = 3 Tevet 5777
        IDate<JewishCalendar> d0h = ICalendar.JEWISH.fromYMD(5777, 10, 3);
        // 8th day of Chanukah 5778 = 2 Tevet 5778
        IDate<JewishCalendar> d1h = ICalendar.JEWISH.fromYMD(5778, 10, 2);
