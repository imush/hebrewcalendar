...
public class HebrewCalendarTest
{
    ...
    public void testMolad()
    {
        ...
        HebrewTime moladElul5777 = hc.molad(5777,6);
        HebrewTime moladTishrei5778 = hc.molad(5778,7);

        HebrewTime moladNisan5778 = hc.molad(5778,1);

        HebrewTime moladNisan5779 = hc.molad(5779,1);
        HebrewTime moladElul5779 = hc.molad(5779,6);
        HebrewTime moladTishrei5780 = hc.molad(5780,7);

        HebrewTime moladNisan5781 = hc.molad(5781,1);

        assertEquals(new HebrewTime(2109992, 16, 807), moladElul5777);
        assertEquals(new HebrewTime(2110022, 5, 520), moladTishrei5778);
    ...
    public void testRoshHashanaAbsDay()
    {
        ...
        HebrewTime molad5775 = hc.molad(5775,7);
        HebrewTime molad5776 = hc.molad(5776,7);
    ...
    {
        assertEquals("0001-01-01H", hc.fromYMD(1, HebrewMonth.NISAN.getOrdinalNumber(),1).toString());
        assertEquals("5777-07-09H", hc.fromYMD(5777, HebrewMonth.TISHREI.getOrdinalNumber(),9).toString());
        assertEquals("5711-11-10H", hc.fromYMD(5711, HebrewMonth.SHVAT.getOrdinalNumber(),10).toString());
    }
