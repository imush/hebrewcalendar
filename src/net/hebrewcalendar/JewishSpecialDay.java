...
import net.hebrewcalendar.data.JewishSpecialDayKey;
...
{
    NISAN_11(new MonthDaySpecialDay<>(ICalendar.JEWISH, "11 Nisan", 1, 11), JewishSpecialDayKey.NISAN_11),
    EREV_PESACH(new MonthDaySpecialDay<>(ICalendar.JEWISH, "Erev Pesach", 1, 14), JewishSpecialDayKey.EREV_PESACH),
    FIRST_DAY_PESACH(new MonthDaySpecialDay<>(ICalendar.JEWISH, "Pesach", 1, 15), JewishSpecialDayKey.PESACH),
    SECOND_DAY_PESACH_C(new MonthDaySpecialDay<>(ICalendar.JEWISH, "2nd day of Pesach", 1, 16), JewishSpecialDayKey.PESACH),
    SEVENTH_DAY_PESACH(new MonthDaySpecialDay<>(ICalendar.JEWISH, "7th day of Pesach", 1, 21), JewishSpecialDayKey.PESACH),
    LAST_DAY_PESACH_C(new MonthDaySpecialDay<>(ICalendar.JEWISH, "Last day of Pesach", 1, 22), JewishSpecialDayKey.PESACH),
    CHOL_HAMOED_PESACH_1I(new MonthDaySpecialDay<>(ICalendar.JEWISH, "Chol Hamoed Pesach", 1, 16), JewishSpecialDayKey.CHOL_HAMOED_PESACH),
    CHOL_HAMOED_PESACH_2I(new MonthDaySpecialDay<>(ICalendar.JEWISH, "Chol Hamoed Pesach", 1, 17), JewishSpecialDayKey.CHOL_HAMOED_PESACH),
    CHOL_HAMOED_PESACH_3I(new MonthDaySpecialDay<>(ICalendar.JEWISH, "Chol Hamoed Pesach", 1, 18), JewishSpecialDayKey.CHOL_HAMOED_PESACH),
    CHOL_HAMOED_PESACH_4I(new MonthDaySpecialDay<>(ICalendar.JEWISH, "Chol Hamoed Pesach", 1, 19), JewishSpecialDayKey.CHOL_HAMOED_PESACH),
    CHOL_HAMOED_PESACH_5I(new MonthDaySpecialDay<>(ICalendar.JEWISH, "Chol Hamoed Pesach", 1, 20), JewishSpecialDayKey.CHOL_HAMOED_PESACH),
    CHOL_HAMOED_PESACH_1C(new MonthDaySpecialDay<>(ICalendar.JEWISH, "Chol Hamoed Pesach", 1, 17), JewishSpecialDayKey.CHOL_HAMOED_PESACH),
    CHOL_HAMOED_PESACH_2C(new MonthDaySpecialDay<>(ICalendar.JEWISH, "Chol Hamoed Pesach", 1, 18), JewishSpecialDayKey.CHOL_HAMOED_PESACH),
    CHOL_HAMOED_PESACH_3C(new MonthDaySpecialDay<>(ICalendar.JEWISH, "Chol Hamoed Pesach", 1, 19), JewishSpecialDayKey.CHOL_HAMOED_PESACH),
    CHOL_HAMOED_PESACH_4C(new MonthDaySpecialDay<>(ICalendar.JEWISH, "Chol Hamoed Pesach", 1, 20), JewishSpecialDayKey.CHOL_HAMOED_PESACH),
    SHABBAT_HAGADOL(new NthDayOfWeekFromPivot<>(ICalendar.JEWISH, "Shabbat Hagadol", FIRST_DAY_PESACH, 7, -1, false), JewishSpecialDayKey.SHABBAT_HAGADOL),
    ...
    SHABBAT_SHEKALIM(new NthDayOfWeekFromPivot<>(ICalendar.JEWISH, "Shabbat Shekalim",
            new MonthDaySpecialDay<>(ICalendar.JEWISH, "1 Adar", -1, 1), 7, -1, true), JewishSpecialDayKey.SHABBAT_SHEKALIM),
    SHABBAT_ZACHOR(new NthDayOfWeekFromPivot<>(ICalendar.JEWISH, "Shabbat Zachor",
            new MonthDaySpecialDay<>(ICalendar.JEWISH, "13 Adar", -1, 13), 7, -1, true), JewishSpecialDayKey.SHABBAT_ZACHOR),
    SHABBAT_PARA(new NthDayOfWeekFromPivot<>(ICalendar.JEWISH, "Shabbat Para",
            new MonthDaySpecialDay<>(ICalendar.JEWISH, "1 Nisan", 1, 1), 7, -2, true), JewishSpecialDayKey.SHABBAT_PARA),
    SHABBAT_HACHODESH(new NthDayOfWeekFromPivot<>(ICalendar.JEWISH, "Shabbat Hachodesh",
            new MonthDaySpecialDay<>(ICalendar.JEWISH, "1 Nisan", 1, 1), 7, -1, true), JewishSpecialDayKey.SHABBAT_HACHODESH),
    PESACH_SHENI(new MonthDaySpecialDay<>(ICalendar.JEWISH, "Pesach Sheni", 2, 14), JewishSpecialDayKey.PESACH_SHENI),
    LAG_BAOMER(new MonthDaySpecialDay<>(ICalendar.JEWISH, "Lag Baomer", 2, 18), JewishSpecialDayKey.LAG_BAOMER),
    SHAVUOT(new MonthDaySpecialDay<>(ICalendar.JEWISH, "Shavuot", 3, 6), JewishSpecialDayKey.SHAVUOT),
    SHAVUOT_2C(new MonthDaySpecialDay<>(ICalendar.JEWISH, "2nd day of Shavuot", 3, 7), JewishSpecialDayKey.SHAVUOT),
    TAMUZ_3(new MonthDaySpecialDay<>(ICalendar.JEWISH, "3 Tamuz", 4, 3), JewishSpecialDayKey.TAMUZ_3),
    ...
    FAST_AV_9(new UnionSpecialDay<>("Fast of 9th Av",
            ...
            new ConjunctionSpecialDay<>("9 Av no Shabbos",
                    ...
                    new NthDayOfWeek<>(ICalendar.JEWISH, 1))
    ), JewishSpecialDayKey.FAST_9_AV),
    SHABBAT_CHAZON(new NthDayOfWeekFromPivot<>(ICalendar.JEWISH, "Shabbat Chazon",
            new MonthDaySpecialDay<>(ICalendar.JEWISH, "9 Av", 5, 9), 7, -1, true), JewishSpecialDayKey.SHABBAT_CHAZON),
    SHABBAT_NACHAMU(new NthDayOfWeekFromPivot<>(ICalendar.JEWISH, "Shabbat Nachamu",
            new MonthDaySpecialDay<>(ICalendar.JEWISH, "9 Av", 5, 9), 7, 1, false), JewishSpecialDayKey.SHABBAT_NACHAMU),
    CHAI_ELUL(new MonthDaySpecialDay<>(ICalendar.JEWISH, "Chai Elul", 6, 18), JewishSpecialDayKey.CHAI_ELUL),
    ROSH_HASHANA_1(new MonthDaySpecialDay<>(ICalendar.JEWISH, "First day Rosh Hashana", 7, 1), JewishSpecialDayKey.ROSH_HASHANA),
    ROSH_HASHANA_2(new MonthDaySpecialDay<>(ICalendar.JEWISH, "2nd day Rosh Hashana", 7, 2), JewishSpecialDayKey.ROSH_HASHANA),
    SHABBAT_SHUVAH(new NthDayOfWeekFromPivot<>(ICalendar.JEWISH, "Shabbat Shuvah",
            ROSH_HASHANA_1, 7, 1, false), JewishSpecialDayKey.SHABBAT_SHUVAH),
    ROSH_CHODESH(new ConjunctionSpecialDay<>("Rosh Chodesh",
            ...
            new NegationSpecialDay<>("exclude Rosh Hashana", ROSH_HASHANA_1)), JewishSpecialDayKey.ROSH_CHODESH),
    TZOM_GEDALIA(new TzomGedaliaSpecialDay("Tzom Gedalia"), JewishSpecialDayKey.TZOM_GEDALIA),
    EREV_YOM_KIPPUR(new MonthDaySpecialDay<>(ICalendar.JEWISH, "Erev Yom Kippur", 7, 9), JewishSpecialDayKey.EREV_YOM_KIPPUR),
    YOM_KIPPUR(new MonthDaySpecialDay<>(ICalendar.JEWISH, "Yom Kippur", 7, 10), JewishSpecialDayKey.YOM_KIPPUR),
    FIRST_DAY_SUKKOT(new MonthDaySpecialDay<>(ICalendar.JEWISH, "1st day Sukkot", 7, 15), JewishSpecialDayKey.SUKKOT),
    SECOND_DAY_SUKKOT_C(new MonthDaySpecialDay<>(ICalendar.JEWISH, "2nd day Sukkot", 7, 16), JewishSpecialDayKey.SUKKOT),
    SHMINI_ATZERES_C(new MonthDaySpecialDay<>(ICalendar.JEWISH, "Shemini Atzeret", 7, 22), JewishSpecialDayKey.SHMINI_ATZERET),
    SIMCHAT_TORAH_C(new MonthDaySpecialDay<>(ICalendar.JEWISH, "Simchat Torah", 7, 23), JewishSpecialDayKey.SIMCHAT_TORAH),
    CHOL_HAMOED_SUKKOT_1I(new MonthDaySpecialDay<>(ICalendar.JEWISH, "Chol Hamoed Sukkot", 7, 16), JewishSpecialDayKey.CHOL_HAMOED_SUKKOT),
    CHOL_HAMOED_SUKKOT_2I(new MonthDaySpecialDay<>(ICalendar.JEWISH, "Chol Hamoed Sukkot", 7, 17), JewishSpecialDayKey.CHOL_HAMOED_SUKKOT),
    CHOL_HAMOED_SUKKOT_3I(new MonthDaySpecialDay<>(ICalendar.JEWISH, "Chol Hamoed Sukkot", 7, 18), JewishSpecialDayKey.CHOL_HAMOED_SUKKOT),
    CHOL_HAMOED_SUKKOT_4I(new MonthDaySpecialDay<>(ICalendar.JEWISH, "Chol Hamoed Sukkot", 7, 19), JewishSpecialDayKey.CHOL_HAMOED_SUKKOT),
    CHOL_HAMOED_SUKKOT_5I(new MonthDaySpecialDay<>(ICalendar.JEWISH, "Chol Hamoed Sukkot", 7, 20), JewishSpecialDayKey.CHOL_HAMOED_SUKKOT),
    HOSHANA_RABBA(new MonthDaySpecialDay<>(ICalendar.JEWISH, "Hoshana Rabba", 7, 21), JewishSpecialDayKey.HOSHANA_RABBA),
    CHOL_HAMOED_SUKKOT_1C(new MonthDaySpecialDay<>(ICalendar.JEWISH, "Chol Hamoed Sukkot", 7, 17), JewishSpecialDayKey.CHOL_HAMOED_SUKKOT),
    CHOL_HAMOED_SUKKOT_2C(new MonthDaySpecialDay<>(ICalendar.JEWISH, "Chol Hamoed Sukkot", 7, 18), JewishSpecialDayKey.CHOL_HAMOED_SUKKOT),
    CHOL_HAMOED_SUKKOT_3C(new MonthDaySpecialDay<>(ICalendar.JEWISH, "Chol Hamoed Sukkot", 7, 19), JewishSpecialDayKey.CHOL_HAMOED_SUKKOT),
    CHOL_HAMOED_SUKKOT_4C(new MonthDaySpecialDay<>(ICalendar.JEWISH, "Chol Hamoed Sukkot", 7, 20), JewishSpecialDayKey.CHOL_HAMOED_SUKKOT),
    SIMCHAT_TORAH_I(new MonthDaySpecialDay<>(ICalendar.JEWISH, "Simchat Torah", 7, 22), JewishSpecialDayKey.SIMCHAT_TORAH),
    TAL_UMATAR_I(new TalUMatar(true, "Tal Umatar"), JewishSpecialDayKey.TAL_UMATAR),
    TAL_UMATAR_C(new TalUMatar(false, "Tal Umatar"), JewishSpecialDayKey.TAL_UMATAR),
    NINETEENTH_KISLEV(new MonthDaySpecialDay<>(ICalendar.JEWISH, "19 Kislev", 9, 19), JewishSpecialDayKey.NINETEENTH_KISLEV),
    FIRST_DAY_CHANUKAH(new MonthDaySpecialDay<>(ICalendar.JEWISH, "1st day Chanukah", 9, 25), JewishSpecialDayKey.CHANUKAH),
    SECOND_DAY_CHANUKAH(new ShiftedDateSpecialDay<>(  "2nd day Chanukah", FIRST_DAY_CHANUKAH, 1), JewishSpecialDayKey.CHANUKAH),
    THIRD_DAY_CHANUKAH(new ShiftedDateSpecialDay<>(   "3rd day Chanukah", FIRST_DAY_CHANUKAH, 2), JewishSpecialDayKey.CHANUKAH),
    FOURTH_DAY_CHANUKAH(new ShiftedDateSpecialDay<>(  "4th day Chanukah", FIRST_DAY_CHANUKAH, 3), JewishSpecialDayKey.CHANUKAH),
    FIFTH_DAY_CHANUKAH(new ShiftedDateSpecialDay<>(   "5th day Chanukah", FIRST_DAY_CHANUKAH, 4), JewishSpecialDayKey.CHANUKAH),
    ...
    PURIM(new MonthDaySpecialDay<>(ICalendar.JEWISH, "Purim", -1, 14), JewishSpecialDayKey.PURIM),
    SHUSHAN_PURIM(new MonthDaySpecialDay<>(ICalendar.JEWISH, "Shushan Purim", -1, 15), JewishSpecialDayKey.SHUSHAN_PURIM),
    PURIM_KATAN(new ConjunctionSpecialDay<>("Purim Katan",
            new MonthDaySpecialDay<>(ICalendar.JEWISH, "12 Adar I", 12, 14),
            new NegationSpecialDay<>("exclude Purim", PURIM)), JewishSpecialDayKey.PURIM_KATAN),
    TAANIT_ESTHER(new TaanitEstherSpecialDay("Fast of Esther"), JewishSpecialDayKey.TAANIT_ESTHER),
    ...
    ), JewishSpecialDayKey.ERUV_TAVSHILIN),

    BIRKAT_HACHAMA(new BirkatHachama("Birkat HaChama"), JewishSpecialDayKey.BIRKAT_HACHAMA),
    ...
    /** Shared-data category — carries localized display strings for this day. */
    public final JewishSpecialDayKey category;

    JewishSpecialDay(SpecialDay<JewishCalendar> delegate, JewishSpecialDayKey category) {
        _delegate = delegate;
