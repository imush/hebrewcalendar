        ...
        implements HHoliday
{
    ...
    TAMUZ_3(new MonthDayHoliday(HCalendar.HEBREW, "12th of Tamuz", 4, 3)),
    TAMUZ_12(new MonthDayHoliday(HCalendar.HEBREW, "12th of Tamuz", 4, 12)),
    TAMUZ_13(new MonthDayHoliday(HCalendar.HEBREW, "12th of Tamuz", 4, 13)),
    ...
    TENTH_TEVES(new MonthDayHoliday(HCalendar.HEBREW, "Fast of 10 Tevet", 10, 10)),
    YUD_SHVAT(new MonthDayHoliday(HCalendar.HEBREW, "10 Shvat", 11, 10)),
    TU_BESHVAT(new MonthDayHoliday(HCalendar.HEBREW, "Tu Beshvat", 11, 15)),
    PURIM(new MonthDayHoliday(HCalendar.HEBREW, "Tu Beshvat", -1, 14)),
    SHUSHAN_PURIM(new MonthDayHoliday(HCalendar.HEBREW, "Tu Beshvat", -1, 15)),
