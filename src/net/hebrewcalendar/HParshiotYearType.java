...
import static net.hebrewcalendar.YearCheshvanKislevType.*;
...
public enum HParshiotYearType {
    ...
    final int pesach;
    private final Function<Boolean, List<Parsha[]>> schedule;

    HParshiotYearType(int rosh, YearCheshvanKislevType yearType, int pesach,
                      Function<Boolean, List<Parsha[]>> schedule) {
        this.rosh     = rosh;
    ...
    public List<Parsha[]> schedule(boolean inIsrael) {
        return schedule.apply(inIsrael);
    }

    public static HParshiotYearType forYear(int rosh, YearCheshvanKislevType yearType, int pesach) {
        for (HParshiotYearType t : values())
    ...
    private static Parsha[] s(Parsha a)           { return new Parsha[]{a}; }
    private static Parsha[] d(Parsha a, Parsha b) { return new Parsha[]{a, b}; }

    // ── schedule definitions ──────────────────────────────────────────────────
    // null entry = Shabbat with Yom Tov / Chol Hamoed reading (no regular parsha)

    // ── A : Mon/Full/Thu  Israel (50 Shabbatot) — also B and C Israel ─────────
    private static List<Parsha[]> scheduleF25_I() {
        return Arrays.asList(
            s(VAYEILECH), s(HAAZINU), null,
            ...
            d(VAYAKHEL,PEKUDEI), s(VAYIKRA), s(TZAV), null,
    ...
    private static List<Parsha[]> scheduleF25_D() {
        return Arrays.asList(
            s(VAYEILECH), s(HAAZINU), null,
            s(BEREISHIT), s(NOACH), s(LECH_LECHA), s(VAYERA), s(CHAYEI_SARAH),
            s(TOLDOT), s(VAYETZE), s(VAYISHLACH), s(VAYESHEV), s(MIKETZ),
            ...
            d(VAYAKHEL,PEKUDEI), s(VAYIKRA), s(TZAV), null,
            s(SHEMINI), d(TAZRIA,METZORA), d(ACHAREI_MOT,KEDOSHIM), s(EMOR),
            d(BEHAR,BECHUKOTAI), s(BAMIDBAR), null,
    ...
    private static List<Parsha[]> scheduleF51() {
        return Arrays.asList(
            s(HAAZINU), null, null,
            s(BEREISHIT), s(NOACH), s(LECH_LECHA), s(VAYERA), s(CHAYEI_SARAH),
            s(TOLDOT), s(VAYETZE), s(VAYISHLACH), s(VAYESHEV), s(MIKETZ),
            s(VAYIGASH), s(VAYECHI), s(SHEMOT), s(VAERA), s(BO), s(BESHALACH),
            s(YITRO), s(MISHPATIM), s(TERUMAH), s(TETZAVEH), s(KI_TISA),
            s(VAYAKHEL), s(PEKUDEI), s(VAYIKRA), s(TZAV), null,
            s(SHEMINI), d(TAZRIA,METZORA), d(ACHAREI_MOT,KEDOSHIM), s(EMOR),
            d(BEHAR,BECHUKOTAI), s(BAMIDBAR), s(NASO), s(BEHAALOTECHA),
            s(SHELACH), s(KORACH), s(CHUKAT), s(BALAK), s(PINCHAS),
            d(MATOT,MASEI), s(DEVARIM), s(VAETCHANAN), s(EIKEV), s(REEH),
    ...
    private static List<Parsha[]> scheduleN57_I() {
        return Arrays.asList(
            s(HAAZINU), null, null,
            s(BEREISHIT), s(NOACH), s(LECH_LECHA), s(VAYERA), s(CHAYEI_SARAH),
            s(TOLDOT), s(VAYETZE), s(VAYISHLACH), s(VAYESHEV), s(MIKETZ),
    ...
    private static List<Parsha[]> scheduleN57_D() {
        return Arrays.asList(
            s(HAAZINU), null, null,
            s(BEREISHIT), s(NOACH), s(LECH_LECHA), s(VAYERA), s(CHAYEI_SARAH),
            s(TOLDOT), s(VAYETZE), s(VAYISHLACH), s(VAYESHEV), s(MIKETZ),
            s(VAYIGASH), s(VAYECHI), s(SHEMOT), s(VAERA), s(BO), s(BESHALACH),
            s(YITRO), s(MISHPATIM), s(TERUMAH), s(TETZAVEH), s(KI_TISA),
            d(VAYAKHEL,PEKUDEI), s(VAYIKRA), s(TZAV), null, null,
            s(SHEMINI), d(TAZRIA,METZORA), d(ACHAREI_MOT,KEDOSHIM), s(EMOR),
            d(BEHAR,BECHUKOTAI), s(BAMIDBAR), null,
            s(NASO), s(BEHAALOTECHA), s(SHELACH), s(KORACH), d(CHUKAT,BALAK),
            s(PINCHAS), d(MATOT,MASEI), s(DEVARIM), s(VAETCHANAN), s(EIKEV),
    ...
    private static List<Parsha[]> scheduleF73() {
        return Arrays.asList(
            null, s(HAAZINU), null, null,
            s(BEREISHIT), s(NOACH), s(LECH_LECHA), s(VAYERA), s(CHAYEI_SARAH),
            s(TOLDOT), s(VAYETZE), s(VAYISHLACH), s(VAYESHEV), s(MIKETZ),
            s(VAYIGASH), s(VAYECHI), s(SHEMOT), s(VAERA), s(BO), s(BESHALACH),
            s(YITRO), s(MISHPATIM), s(TERUMAH), s(TETZAVEH), s(KI_TISA),
    ...
    private static List<Parsha[]> scheduleS71() {
        return Arrays.asList(
            null, s(HAAZINU), null, null,
            s(BEREISHIT), s(NOACH), s(LECH_LECHA), s(VAYERA), s(CHAYEI_SARAH),
            s(TOLDOT), s(VAYETZE), s(VAYISHLACH), s(VAYESHEV), s(MIKETZ),
    ...
    private static List<Parsha[]> scheduleF27_I() {
        return Arrays.asList(
            s(VAYEILECH), s(HAAZINU), null,
            s(BEREISHIT), s(NOACH), s(LECH_LECHA), s(VAYERA), s(CHAYEI_SARAH),
            s(TOLDOT), s(VAYETZE), s(VAYISHLACH), s(VAYESHEV), s(MIKETZ),
            ...
            s(SHEMINI), s(TAZRIA), s(METZORA), null,
    ...
    private static List<Parsha[]> scheduleF27_D() {
        return Arrays.asList(
            s(VAYEILECH), s(HAAZINU), null,
            s(BEREISHIT), s(NOACH), s(LECH_LECHA), s(VAYERA), s(CHAYEI_SARAH),
            s(TOLDOT), s(VAYETZE), s(VAYISHLACH), s(VAYESHEV), s(MIKETZ),
            ...
            s(YITRO), s(MISHPATIM), s(TERUMAH), s(TETZAVEH), s(KI_TISA),
            s(VAYAKHEL), s(PEKUDEI), s(VAYIKRA), s(TZAV),
            s(SHEMINI), s(TAZRIA), s(METZORA), null, null,
            s(ACHAREI_MOT), s(KEDOSHIM), s(EMOR), s(BEHAR), s(BECHUKOTAI),
            s(BAMIDBAR), s(NASO), s(BEHAALOTECHA), s(SHELACH), s(KORACH),
    ...
    private static List<Parsha[]> scheduleS25_I() {
        return Arrays.asList(
            s(VAYEILECH), s(HAAZINU), null,
            s(BEREISHIT), s(NOACH), s(LECH_LECHA), s(VAYERA), s(CHAYEI_SARAH),
            s(TOLDOT), s(VAYETZE), s(VAYISHLACH), s(VAYESHEV), s(MIKETZ),
    ...
    private static List<Parsha[]> scheduleS25_D() {
        return Arrays.asList(
            s(VAYEILECH), s(HAAZINU), null,
            s(BEREISHIT), s(NOACH), s(LECH_LECHA), s(VAYERA), s(CHAYEI_SARAH),
            s(TOLDOT), s(VAYETZE), s(VAYISHLACH), s(VAYESHEV), s(MIKETZ),
    ...
    private static List<Parsha[]> scheduleN37_I() {
        return Arrays.asList(
            s(VAYEILECH), s(HAAZINU), null,
            s(BEREISHIT), s(NOACH), s(LECH_LECHA), s(VAYERA), s(CHAYEI_SARAH),
            s(TOLDOT), s(VAYETZE), s(VAYISHLACH), s(VAYESHEV), s(MIKETZ),
    ...
    private static List<Parsha[]> scheduleN37_D() {
        return Arrays.asList(
            s(VAYEILECH), s(HAAZINU), null,
            s(BEREISHIT), s(NOACH), s(LECH_LECHA), s(VAYERA), s(CHAYEI_SARAH),
            s(TOLDOT), s(VAYETZE), s(VAYISHLACH), s(VAYESHEV), s(MIKETZ),
    ...
    private static List<Parsha[]> scheduleF53() {
        return Arrays.asList(
            s(HAAZINU), null, null,
            s(BEREISHIT), s(NOACH), s(LECH_LECHA), s(VAYERA), s(CHAYEI_SARAH),
            s(TOLDOT), s(VAYETZE), s(VAYISHLACH), s(VAYESHEV), s(MIKETZ),
            ...
            s(YITRO), s(MISHPATIM), s(TERUMAH), s(TETZAVEH), s(KI_TISA),
            s(VAYAKHEL), s(PEKUDEI), s(VAYIKRA), s(TZAV),
            s(SHEMINI), s(TAZRIA), s(METZORA), s(ACHAREI_MOT), null,
    ...
    private static List<Parsha[]> scheduleS51() {
        return Arrays.asList(
            s(HAAZINU), null, null,
            s(BEREISHIT), s(NOACH), s(LECH_LECHA), s(VAYERA), s(CHAYEI_SARAH),
            s(TOLDOT), s(VAYETZE), s(VAYISHLACH), s(VAYESHEV), s(MIKETZ),
    ...
    private static List<Parsha[]> scheduleF75_I() {
        return Arrays.asList(
            null, s(HAAZINU), null, null,
            s(BEREISHIT), s(NOACH), s(LECH_LECHA), s(VAYERA), s(CHAYEI_SARAH),
            s(TOLDOT), s(VAYETZE), s(VAYISHLACH), s(VAYESHEV), s(MIKETZ),
    ...
    private static List<Parsha[]> scheduleF75_D() {
        return Arrays.asList(
            null, s(HAAZINU), null, null,
            s(BEREISHIT), s(NOACH), s(LECH_LECHA), s(VAYERA), s(CHAYEI_SARAH),
            s(TOLDOT), s(VAYETZE), s(VAYISHLACH), s(VAYESHEV), s(MIKETZ),
    ...
    private static List<Parsha[]> scheduleS73() {
        return Arrays.asList(
            null, s(HAAZINU), null, null,
            s(BEREISHIT), s(NOACH), s(LECH_LECHA), s(VAYERA), s(CHAYEI_SARAH),
            s(TOLDOT), s(VAYETZE), s(VAYISHLACH), s(VAYESHEV), s(MIKETZ),
